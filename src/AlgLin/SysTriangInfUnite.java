...
public class SysTriangInfUnite extends SysLin{
  ...
  public static void main(String[] args) throws IrregularSysLinException {
    ...
    double[][] t1 = {{1.0,0.0,0.0},{3.0,1.0,0.0},{2.0,4.0,1.0}};
    ...
    SysTriangInfUnite s1 = new SysTriangInfUnite(m1, v1);
    SysTriangInfUnite s2 = new SysTriangInfUnite(m2, v1);
  ...
  public SysTriangInfUnite(Matrice premMembre, Vecteur secMembre) throws IrregularSysLinException {
